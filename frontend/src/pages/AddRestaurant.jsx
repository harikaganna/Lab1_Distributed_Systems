      ...
      <div className="col-md-8">
        <div className="card card-clean">
          <div className="card-header">
            <h5 className="mb-0">Add a Restaurant</h5>
          </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="row g-3">
                ...
                <div className="col-md-2">
                  ...
                  <input className="form-control" value={form.state} onChange={updateField("state")} maxLength={5} placeholder="CA" />
                </div>
                <div className="col-md-2">
                ...
                <div className="col-md-6">
                  ...
                  <input className="form-control" value={form.hours} onChange={updateField("hours")} placeholder="Mon-Fri 9am-10pm" />
                </div>
                <div className="col-md-6">
                  <label className="form-label">Amenities</label>
                  <input className="form-control" value={form.amenities} onChange={updateField("amenities")} placeholder="wifi, outdoor seating" />
                </div>
              </div>
